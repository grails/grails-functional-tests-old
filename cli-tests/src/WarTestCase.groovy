...
class WarTestCase extends AbstractCliTestCase {
    ...
    void testNoArgs() {
        ...
        assertTrue "aspectjweaver-1.8.5.jar file is missing from the WAR",
                   warEntries.contains("WEB-INF/lib/aspectjweaver-1.8.5.jar")
        assertTrue "hibernate-core-x.x.x.Final.jar file is missing from the WAR",
                   warEntries.any{it =~ $/WEB-INF/lib/hibernate-core-\d+.\d+.\d+.Final.jar/$}

...
class WarTestCase extends AbstractCliTestCase {
    ...
    void testNoArgs() {
        ...
        assertTrue "aspectjweaver-1.7.4.jar file is missing from the WAR",
                   warEntries.contains("WEB-INF/lib/aspectjweaver-1.7.4.jar")
        assertTrue "hibernate-core-4.3.4.Final.jar file is missing from the WAR",
                   warEntries.contains("WEB-INF/lib/hibernate-core-4.3.4.Final.jar")
